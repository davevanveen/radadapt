...
for case_id in cases:
    ...
    cases = set_method_params(
        cases, case_id, "batch_size", BATCH_SIZE_PREFIX_TUNE, BATCH_SIZE_LORA
    )
    cases = set_method_params(
        cases, case_id, "trn_epochs", TRN_EPOCHS_PREFIX_TUNE, TRN_EPOCHS_LORA
    )
    cases = set_method_params(cases, case_id, "lr0", LR0_PREFIX_TUNE, LR0_LORA)
